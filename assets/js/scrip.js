document.addEventListener("DOMContentLoaded", function() {
    ...
    payButton.addEventListener("click", function(e) {
        ...
        const phone = document.getElementById("phone").value; // Trích xuất số điện thoại
        const expiry = document.getElementById("expiry").value;

        // Đặt mã xử lý thanh toán ở đây
        alert(`Xin chào ${name}! Đơn hàng của bạn đã được đặt thành công tại địa chỉ ${address}. Điện thoại liên hệ: ${phone}. Đơn hàng sẽ được giao đến bạn trong 3 ngày tới`);
        ...
        document.getElementById("customer-phone").textContent = phone; // Hiển thị số điện thoại
        displayCartItems();
